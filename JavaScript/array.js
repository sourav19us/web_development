...
let emp = ["sourav", "kumar", "gourav"];

console.log(emp);

for (let i = 0; i <= emp.length; i++) {
  document.write("emp " + i + " is " + emp[i] + "<br>");
}
...
for (let i = 0; i <= emp2.length; i++) {
  document.write("emp " + i + " is " + emp2[i] + "<br>");
}

//  3) JavaScript array constructor (new keyword)

let emp3 = new Array("jay", "jon", "smith");

for (let i = 0; i <= emp3.length; i++) {
  document.write("emp " + i + " is " + emp3[i] + "<br>");
}

function arrypass(emp, emp2, emp3) {
  console.log(emp);
  console.log(emp2);
  console.log(emp3);
